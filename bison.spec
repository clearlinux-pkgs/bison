...
Source0  : https://mirrors.kernel.org/gnu/bison/bison-3.8.2.tar.xz
Source1  : https://mirrors.kernel.org/gnu/bison/bison-3.8.2.tar.xz.sig
...
%prep
%setup -q -n bison-3.8.2
cd %{_builddir}/bison-3.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701936375
...
cp %{_builddir}/bison-%{version}/COPYING %{buildroot}/usr/share/package-licenses/bison/31a3d460bb3c7d98845187c716a30db81c44b615 || :
%make_install
